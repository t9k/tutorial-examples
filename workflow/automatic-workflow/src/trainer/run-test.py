...
def main():
    ...
    parser.add_argument('--dst', type=str, help='destinaiton, in the format bucket/<key>')
    parser.add_argument('--key', type=str, default='minio', help='mino key')
    parser.add_argument('--secret', type=str, default='minio123', help='mino secret')
    parser.add_argument('--endpoint', type=str, default='localhost:9000', help='mino key')
