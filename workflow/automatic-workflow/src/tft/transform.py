...
def preprocess(inputs):
  ...
  """
    ...
    for key in DENSE_FLOAT_FEATURE_KEYS:
        ...
        outputs[key] = transform.scale_to_z_score(_fill_in_missing(
            inputs[key]))
    ...
    for key in BUCKET_FEATURE_KEYS:
        outputs[key] = transform.bucketize(_fill_in_missing(inputs[key]),
...
def run_transform(output_dir,
  ...
  """
    ...
    tft_input_metadata = dataset_metadata.DatasetMetadata(
        make_tft_input_metadata(schema_list))
